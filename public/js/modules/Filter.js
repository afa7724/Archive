...
export default class Filer {
    ...
    bindEvents () {
      ...
      this.form.querySelectorAll('.form-group').forEach(span => {
        span.addEventListener('change', this.loadForm.bind(this))
      })
    }
    ...
    /**
     * Remplace les elements de la grille avec un effer d'animation flip
